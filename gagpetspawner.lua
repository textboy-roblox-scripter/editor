...
local Window = Rayfield:CreateWindow({
    Name = "GROW A GARDEN SPRNIKLER spawner", 
    Icon = 0,
    LoadingTitle = "SPRINKLER SPAWNER", 
    LoadingSubtitle = "by code phantom ", 
    Theme = "Amethyst",
    ToggleUIKeybind = "K",
    DisableRayfieldPrompts = false,
    DisableBuildWarnings = false, 
     fConfigurationSaving = {
       Enabled = false,
       FolderName = nil,
       FileName = ""
    },
    Discord = {
       Enabled = true,
       Invite = "https://discord.gg/83eV2U4a8G",
       RememberJoins = true
    },
    KeySystem = true,
    KeySettings = {
       Title = "key system",
       Subtitle = "get key to unlock",
       Note = "visit : https://rekonise.com/key-system-47b8l for key", 
       FileName = "Key",
       SaveKey = true, 
