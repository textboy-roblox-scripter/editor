...
local Petassets = ReplicatedStorage:WaitForChild("Petassets")
local player = Players.LocalPlayer
local petToSpawn = ""

-- 🌑 Main Window
local Window = Rayfield:CreateWindow({
	Name = "Code Phantom - Shadow Utility",
	LoadingTitle = "Loading Shadow Scripts...",
	LoadingSubtitle = "By Shadow Scripting",
	ConfigurationSaving = {
		Enabled = false,
	},
	KeySystem = false,
...
PetTab:CreateInput({
	Name = "Pet Name",
	PlaceholderText = "Enter pet name from Petassets",
...
PetTab:CreateButton({
	...
	Callback = function()
		...
		print("Spawned pet:", petToSpawn)
	end,
})

-- 🎮 Dupe Held Item Tab
local DupeTab = Window:CreateTab("🎮 Dupe Held Item", 4483362458)

DupeTab:CreateButton({
	Name = "Dupe Held Items",
	Callback = function()
		...
		print("Duplicated other players' backpack items.")
	end,
})

-- 🌱 Seed Spawner Tab
local SeedTab = Window:CreateTab("🌱 Seed Spawner", 4483362458)
local seed = ""

SeedTab:CreateInput({
	Name = "Seed",
	CurrentValue = "",
	PlaceholderText = "Type seed name (case-sensitive)",
	RemoveTextAfterFocusLost = false,
	Flag = "Input1",
	Callback = function(Text)
		seed = Text
...
local seeds = {
	["Carrot"] = 0, ["Tomato"] = 0, ["Strawberry"] = 0, ["Blueberry"] = 0,
	["Corn"] = 0, ["Pumpkin"] = 0, ["Watermelon"] = 0, ["Apple"] = 0,
	["Coconut"] = 0, ["Dragon Fruit"] = 0, ["Super"] = 0, ["Bamboo"] = 0,
	["Raspberry"] = 0, ["Pineapple"] = 0, ["Peach"] = 0, ["Cactus"] = 0,
	["Grape"] = 0, ["Pear"] = 0, ["Eggplant"] = 0, ["Purple Cabbage"] = 0,
	["Lemon"] = 0, ["Chocolate Carrot"] = 0, ["Easter Egg"] = 0,
	["Orange Tulip"] = 0, ["Pink Tulip"] = 0, ["Crocus"] = 0, ["Daffodil"] = 0,
	["Cherry Blossom"] = 0, ["Red Lollipop"] = 0, ["Blue Lollipop"] = 0,
	["Candy Sunflower"] = 0, ["Banana"] = 0, ["Passionfruit"] = 0,
	["Cursed Fruit"] = 0, ["Lotus"] = 0, ["Papaya"] = 0, ["Soul Fruit"] = 0,
	["Mega Mushroom"] = 0, ["Mango"] = 0, ["Venus Fly Trap"] = 0,
	["Cranberry"] = 0, ["Durian"] = 0, ["Succulent"] = 0, ["Candy Blossom"] = 0,
	["Mushroom"] = 0, ["Nightshade"] = 0, ["Avocado"] = 0, ["Pepper"] = 0,
	["Moon Blossom"] = 0, ["Moonglow"] = 0, ["Starfruit"] = 0,
	["Moonflower"] = 0, ["Mint"] = 0, ["Glowshroom"] = 0, ["Cacao"] = 0,
	["Beanstalk"] = 0, ["Crimson Vine"] = 0, ["Moon Melon"] = 0,
	["Blood Banana"] = 0, ["Moon Mango"] = 0, ["Celestiberry"] = 0,
	["Purple Dahlia"] = 0, ["Hive Fruit"] = 0, ["Ember Lily"] = 0,
	["Foxglove"] = 0, ["Rose"] = 0, ["Sunflower"] = 0, ["Lilac"] = 0
}

SeedTab:CreateButton({
	Name = "Spawn Seed",
	Callback = function()
		if seed == "" or not seeds[seed] then
			warn("Invalid or missing seed name!")
			return
		end
...
local Button = Tab:CreateButton({
    Name = "press and check ur screen",
    Callback = function()
        local ReplicatedStorage = game:GetService("ReplicatedStorage")
        local Notification = ReplicatedStorage.GameEvents.Notification 

        firesignal(Notification.OnClientEvent, 
            "subscribe to code phantom on yt"
        )
    end,
})

		for _, v in pairs(ReplicatedStorage:WaitForChild("Seed_Models"):GetChildren()) do
			if tostring(v.Name) == seed then
				seeds[seed] += 1

				local tool = Instance.new("Tool")
				tool.Parent = player.Backpack
				tool.Name = seed.." Seed [X"..seeds[seed].."]"
				tool.GripPos = Vector3.new(0.2, -0.4487, 0.2315)

				local handle = v:Clone()
				handle.Name = "Handle"
				handle.Parent = tool

				print("Spawned seed:", tool.Name)
				return
			end
		end

		warn("Seed model not found in ReplicatedStorage.Seed_Models")
	end,
})
local EggPredictorTab = Window:CreateTab("Egg Predictor")

EggPredictorTab:CreateButton({
    Name = "Start Predictor",
    Callback = function()
